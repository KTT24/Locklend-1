...
namespace Improbable.Gdk.CodeGenerator {
 ...
 if (!fieldDetails.IsBlittable) { 
            ...
            this.Write("#if USE_LEGACY_REACTIVE_COMPONENTS\r\n            ");
 ...
 foreach (var commandDetails in commandDetailsList) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture( CommonGeneratorUtils.IndentEveryNewline(generator.Generate($"{commandDetails.CommandName}Sender", $"List<{componentNamespace}.{commandDetails.CommandName}.Request>"), 3) ));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture( CommonGeneratorUtils.IndentEveryNewline(generator.Generate($"{commandDetails.CommandName}Requests", $"List<{componentNamespace}.{commandDetails.CommandName}.ReceivedRequest>"), 3) ));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture( CommonGeneratorUtils.IndentEveryNewline(generator.Generate($"{commandDetails.CommandName}Responder", $"List<{componentNamespace}.{commandDetails.CommandName}.Response>"), 3) ));
            ...
            #line 45 "Templates/UnityReferenceTypeProviderGenerator.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture( CommonGeneratorUtils.IndentEveryNewline(generator.Generate($"{commandDetails.CommandName}Responses", $"List<{componentNamespace}.{commandDetails.CommandName}.ReceivedResponse>"), 3) ));
            ...
            #line 46 "Templates/UnityReferenceTypeProviderGenerator.tt"
 } 
            
            #line default
            #line hidden
            
            #line 47 "Templates/UnityReferenceTypeProviderGenerator.tt"
            this.Write("#endif\r\n        }\r\n    }\r\n}\r\n");
