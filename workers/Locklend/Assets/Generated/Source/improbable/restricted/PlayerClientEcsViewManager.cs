...
namespace Improbable.Restricted
{
    public partial class PlayerClient
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            {
                global::Improbable.Restricted.PlayerClient.ReferenceTypeProviders.PlayerIdentityProvider.CleanDataInWorld(world);
            }
            ...
            private void RemoveComponent(EntityId entityId)
            {
                ...
                global::Improbable.Restricted.PlayerClient.ReferenceTypeProviders.PlayerIdentityProvider.Free(data.playerIdentityHandle);
